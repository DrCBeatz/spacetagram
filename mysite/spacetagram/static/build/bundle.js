...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "search svelte-ce3ugk");
    			add_location(div, file$2, 35, 2, 557);
    			attr_dev(h1, "class", "title svelte-ce3ugk");
    			add_location(h1, file$2, 36, 2, 613);
    			attr_dev(header, "class", "svelte-ce3ugk");
    			add_location(header, file$2, 33, 0, 543);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Header', slots, ['search','title']);
    	const writable_props = [];
    ...
    // (200:0) <Button mode="outline" on:click={searchImages}>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(200:0) <Button mode=\\\"outline\\\" on:click={searchImages}>",
    		ctx
    	});
    ...
    function create_search_slot(ctx) {
    	...
    	button.$on("click", /*searchImages*/ ctx[4]);

    	const block = {
    		c: function create() {
    			div = element("div");
    			label = element("label");
    			label.textContent = "# of images: ";
    			input = element("input");
    			t1 = space();
    			create_component(button.$$.fragment);
    			attr_dev(label, "class", "label svelte-y4oaih");
    			attr_dev(label, "for", "count");
    			set_style(label, "display", "inline");
    			add_location(label, file, 198, 0, 3372);
    			attr_dev(input, "name", "count");
    			attr_dev(input, "type", "number");
    			attr_dev(input, "min", "1");
    			attr_dev(input, "class", "svelte-y4oaih");
    			add_location(input, file, 198, 77, 3449);
    			attr_dev(div, "slot", "search");
    			attr_dev(div, "class", "svelte-y4oaih");
    			add_location(div, file, 196, 1, 3351);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_title_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-y4oaih");
    			add_location(div, file, 201, 1, 3589);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "Welcome to Spacetagram!";
    			t1 = space();
    			h3 = element("h3");
    			h3.textContent = "Images from NASA's Astronomy Picture of the Day";
    			t3 = space();
    			h5 = element("h5");
    			h5.textContent = "Enter the number of images to load (above) and click \"Load Images\".";
    			attr_dev(h1, "class", "center-text svelte-y4oaih");
    			add_location(h1, file, 231, 1, 4534);
    			attr_dev(h3, "class", "center-text svelte-y4oaih");
    			add_location(h3, file, 232, 1, 4588);
    			attr_dev(h5, "class", "center-text svelte-y4oaih");
    			add_location(h5, file, 233, 2, 4667);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			attr_dev(h1, "class", "center-text svelte-y4oaih");
    			add_location(h1, file, 210, 2, 3716);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			insert_dev(target, t1, anchor);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*likedImages, imageList, toggleLikedImageHandler*/ 35) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(210:2) {#if imageList.length > 0 }",
    		ctx
    	});
    ...
    // (219:3) <Button mode={(likedImages.filter(e => e.date === image.date).length > 0 ) ? "button outline" : "outline success"} on:click={toggleLikedImageHandler(image)}           id={image.date}      >
    function create_default_slot_1(ctx) {
    	let t_value = (/*likedImages*/ ctx[0].filter(func_1).length > 0
    	? 'Unlike'
    	: ' Like ') + "";
    	...
    	function func_1(...args) {
    		return /*func_1*/ ctx[8](/*image*/ ctx[14], ...args);
    	}
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*likedImages, imageList*/ 3 && t_value !== (t_value = (/*likedImages*/ ctx[0].filter(func_1).length > 0
    			? 'Unlike'
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(219:3) <Button mode={(likedImages.filter(e => e.date === image.date).length > 0 ) ? \\\"button outline\\\" : \\\"outline success\\\"} on:click={toggleLikedImageHandler(image)}           id={image.date}      >",
    		ctx
    	});
    ...
    // (225:4) {#if (likedImages.filter(e => e.date === image.date).length > 0 )}
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "heart svelte-y4oaih");
    			set_style(div, "width", "30px");
    			set_style(div, "display", "inline-block");
    			add_location(div, file, 225, 4, 4406);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			current = true;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(225:4) {#if (likedImages.filter(e => e.date === image.date).length > 0 )}",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	let div;
    	let h3;
    	let t0_value = /*image*/ ctx[14].title + "";
    	let t0;
    	let t1;
    	let t2_value = /*image*/ ctx[14].date + "";
    	let t2;
    	let t3;
    	let t4;
    	let img;
    	...
    	let t5;
    	let p0;
    	let t6_value = /*image*/ ctx[14].explanation + "";
    	let t6;
    	let t7;
    	let p1;
    	let button;
    	...
    	let br;
    	let t9;
    	let show_if = /*likedImages*/ ctx[0].filter(func).length > 0;
    	let div_transition;
    	let t10;
    	let current;

    	function func(...args) {
    		return /*func*/ ctx[6](/*image*/ ctx[14], ...args);
    	}

    	function func_2(...args) {
    		return /*func_2*/ ctx[9](/*image*/ ctx[14], ...args);
    	}

    	button = new Button({
    			props: {
    				mode: /*likedImages*/ ctx[0].filter(func_2).length > 0
    				? "button outline"
    				: "outline success",
    				id: /*image*/ ctx[14].date,
    	...
    	button.$on("click", function () {
    		if (is_function(/*toggleLikedImageHandler*/ ctx[5](/*image*/ ctx[14]))) /*toggleLikedImageHandler*/ ctx[5](/*image*/ ctx[14]).apply(this, arguments);
    	});
    	...
    	const block = {
    		c: function create() {
    			...
    			t10 = space();
    			attr_dev(h3, "class", "center-text svelte-y4oaih");
    			add_location(h3, file, 214, 2, 3843);
    			if (!src_url_equal(img.src, img_src_value = /*image*/ ctx[14].url)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", img_alt_value = /*image*/ ctx[14].title);
    			attr_dev(img, "class", "responsive svelte-y4oaih");
    			attr_dev(img, "height", "500");
    			attr_dev(img, "max-width", "1000");
    			add_location(img, file, 215, 2, 3906);
    			attr_dev(p0, "class", "svelte-y4oaih");
    			add_location(p0, file, 216, 2, 3998);
    			attr_dev(br, "class", "svelte-y4oaih");
    			add_location(br, file, 223, 4, 4326);
    			attr_dev(p1, "class", "svelte-y4oaih");
    			add_location(p1, file, 217, 2, 4027);
    			attr_dev(div, "class", "svelte-y4oaih");
    			add_location(div, file, 213, 2, 3819);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h3);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty & /*imageList*/ 2) && t0_value !== (t0_value = /*image*/ ctx[14].title + "")) set_data_dev(t0, t0_value);
    			if ((!current || dirty & /*imageList*/ 2) && t2_value !== (t2_value = /*image*/ ctx[14].date + "")) set_data_dev(t2, t2_value);

    			if (!current || dirty & /*imageList*/ 2 && !src_url_equal(img.src, img_src_value = /*image*/ ctx[14].url)) {
    				attr_dev(img, "src", img_src_value);
    			}

    			if (!current || dirty & /*imageList*/ 2 && img_alt_value !== (img_alt_value = /*image*/ ctx[14].title)) {
    				attr_dev(img, "alt", img_alt_value);
    			}

    			if ((!current || dirty & /*imageList*/ 2) && t6_value !== (t6_value = /*image*/ ctx[14].explanation + "")) set_data_dev(t6, t6_value);
    			const button_changes = {};

    			if (dirty & /*likedImages, imageList*/ 3) button_changes.mode = /*likedImages*/ ctx[0].filter(func_2).length > 0
    			? "button outline"
    			: "outline success";

    			if (dirty & /*imageList*/ 2) button_changes.id = /*image*/ ctx[14].date;

    			if (dirty & /*$$scope, likedImages, imageList*/ 131075) {
    				button_changes.$$scope = { dirty, ctx };
    			}

    			button.$set(button_changes);
    			if (dirty & /*likedImages, imageList*/ 3) show_if = /*likedImages*/ ctx[0].filter(func).length > 0;

    			if (show_if) {
    				if (if_block) {
    					if (dirty & /*likedImages, imageList*/ 3) {
    						transition_in(if_block, 1);
    					}
    				} else {
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(212:1) {#each imageList as image}",
    		ctx
    	});
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let imageList = [];
    	let likedImages = [];
    	let maxNominees = false;
    	let isLoading = false;
    	let count = 1;

    	function searchImages() {
    		fetch(`https://api.nasa.gov/planetary/apod?api_key=dAt0hYR1btozyhNwVCih2alU4bwYFljIrmWtQ4JW&count=${count}`).then(res => {
    			...
    			$$invalidate(1, imageList = data);

    			setTimeout(
    				() => {
    					$$invalidate(2, isLoading = false); //   meetups.setMeetups(loadedMeetups.reverse());
    				},
    				500
    	...
    	function likeImage(image) {
    		console.log(image);
    		$$invalidate(0, likedImages = [...likedImages, image]);
    		console.log(likedImages);
    	}

    	function removeLikedImage(image) {
    		$$invalidate(0, likedImages = likedImages.filter(obj => {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('likedImages' in $$props) $$invalidate(0, likedImages = $$props.likedImages);
    		if ('maxNominees' in $$props) maxNominees = $$props.maxNominees;
